...
`Hoardy-Web` is a Web Extension browser add-on that passively captures and collects dumps of `HTTP` requests and responses as you browse the web (see [`WRR` file format](../doc/data-on-disk.md)), and then archives them to your `Downloads` directory, your own private archiving server (like [`hoardy-web-sas`](../simple_server/) or the more advanced [`hoardy-web serve`](../tool/)), or your browser's local storage.
...
To view your archived data, however, you will need to install at the very least the accompanying [`hoardy-web` tool](https://github.com/Own-Data-Privateer/hoardy-web/tree/master/tool) (also [there](https://oxij.org/software/hoardy-web/tree/master/tool/)).
...
- See the [rest of the `Help` page](./page/help.org) and [higher-level README](../README.md) if you want more info.
  ...
  In the latter, in particular, see [comparisons to alternatives](../README.md#alternatives) to see those and the ["Technical Philosophy" section](../README.md#philosophy) for the design decisions.

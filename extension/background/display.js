...
function getStats() {
    ...
    return {
        ...
        stashed: state.stashedLS.number + state.stashedIDB.number,
        stashed_size: state.stashedLS.size + state.stashedIDB.size,
        unstashed: stashFailed,
        unstashed_size: stashFailedSize,
        exportedAs: state.exportedAsTotal,
        exportedAs_size: state.exportedAsSize,
        bundledAs,
        bundledAs_size: bundledAsSize,
        submittedHTTP: state.submittedHTTPTotal,
        submittedHTTP_size: state.submittedHTTPSize,
        can_replay: config.replaySubmitHTTP !== false && serverConfig.canReplay,
        dumped: state.dumpedTotal,
        dumped_size: state.dumpedSize,
        dumped_real_size: state.dumpedReal,
        written: state.dumpedTotal + state.stashedTotal + state.savedTotal,
        rewritten: state.stashedRedo + state.savedRedo,
        deleted: state.dumpedUndo + state.stashedUndo + state.savedUndo,
        saved: state.savedLS.number + state.savedIDB.number,
        saved_size: state.savedLS.size + state.savedIDB.size,

...
As noted above, if any of the [[./popup.html#sub-config.archive][archival methods]] fail, the reqres in question will be moved into the =unarchived= state.
...
*** Glossary
- [[./popup.html#div-stats.unarchived][A /failed to archive reqres/]] is a reqres that is currently =unarchived=, i.e. a reqres that failed to be archived by one of the enabled [[./popup.html#sub-config.archive][archival methods]].
  It is also a part of the sum of the "Failed" part of the [[./popup.html#div-stats.queued_failed][Queued/Failed]] line.
...
- enable [[./popup.html#sub-config.archive][the option for your desired archival method]] (e.g., [[./popup.html#div-config.archiveExportAs][=Archive 'collected' reqres by > ... exporting them using 'saveAs'=]]),
- but keep the [[./popup.html#div-config.archiveSaveLS][=Archive 'collected' reqres by > ... saving them into local storage= option]] enabled,
- if you are re-archiving by [[./popup.html#div-config.archiveExportAs][=... exporting them using 'saveAs'= option]], you should probably temporarily set [[./popup.html#div-config.exportAsTimeout][this timeout]] to =0= to prevent idle waiting,
...
- =notifications= permission is used to send notifications, which mostly used for reporting various issues.
** Capture

...
Also, pWebArc provides a context menu for links (do a right-click while pointing at a link) which allows opening new tabs and windows with [[./popup.html#div-tabconfig.children.collecting][children tabs setting]] negated to remove the need for "toggle it, middle-click a link, toggle it again" interactions.

...
** Step 3
Then, depending on the [[./popup.html#archive-options]["Archive reqres with" settings]], the reqres in question will either be queued for archival or discarded (displayed as green and red colors respectively in the [[./state.html][Logs]]).
** Step 4

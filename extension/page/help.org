...
- [[./popup.html#div-tabconfig.children.profile][this one]] will be used for requests originating from new tabs opened from the currently active tab (e.g. via middle mouse click, context menu, etc),

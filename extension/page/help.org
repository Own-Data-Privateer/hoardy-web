...
- lists all available [[#shortcuts][keyboard shortcuts]] and [[#context-menu][context menu actions]];
...
There are also [[#shortcuts][keyboard shortcuts]] and [[#context-menu][context menu actions]] for most of the above action.
* Workflows
:PROPERTIES:
:CUSTOM_ID: workflows
:END:

...
To view your archived data, see the accompanying [[https://github.com/Own-Data-Privateer/hoardy-web/tree/master/tool][=hoardy-web= tool]] (also [[https://oxij.org/software/hoardy-web/tree/master/tool/][there]]).
* Conventions
:PROPERTIES:
...
- a =dump=, which is a [[https://github.com/Own-Data-Privateer/hoardy-web/tree/master/doc/data-on-disk.md][=WRR=-formatted dump]] (also [[https://oxij.org/software/hoardy-web/tree/master/doc/data-on-disk.md][there]]) of the original =reqres= structure.
...
Say, for instance, you opened a URL in a new tab, then you forgot about that tab for a while, but then you returned to it again, and you now want to read it.
...
Some websites make their =CSS= do this on purpose to track users that run with =JavaScript= disabled.

Meanwhile, normally, when using the [[https://github.com/Own-Data-Privateer/hoardy-web/tree/master/tool][=hoardy-web= tool]] (also [[https://oxij.org/software/hoardy-web/tree/master/tool/][there]]), pages of static website mirrors generated by its =mirror= sub-command and =HTTP= replay pages generated by its =serve= sub-command remap all URLs of page requisites to point to local files and replay URLs.
...
By default, "Work offline" mode is enabled for =file:= URLs to stop any pages generated by =hoardy-web mirror= to accessing the Internet.
* Shortcuts
...
So, web pages using only simple UI-related =JavaScript= code will work fine when you start replaying them "from scratch" via [[https://github.com/Own-Data-Privateer/hoardy-web/tree/master/tool][=hoardy-web mirror=]] (also [[https://oxij.org/software/hoardy-web/tree/master/tool/][there]]) or some such.

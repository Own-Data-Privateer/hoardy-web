...
No. pWebArc does remember some global stat numbers (like [[./popup.html#div-stats.collected][Collected/Discarded reqres]]) across restarts, but they are never sent anywhere, and [[./popup.html#resetPersistentStats][you can reset them]].

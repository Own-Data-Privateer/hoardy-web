...
- describes [[#start][what the extension does under the hood to capture, archive, and replay your web traffic]], while explaining its most important configuration options, invokable actions, their effects, and available integrations with related tools;

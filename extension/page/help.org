...
You can also ask =Hoardy-Web= to forget all history manually by pressing {{{button2(forgetAllHistory,this button)}}}, or to forget history of reqres generated by the currently active tab by pressing {{{button2(forgetAllTabHistory,that button)}}} instead, or do the same by using similar buttons on the log page {{{logPage}}}.
...
- does not prevent generation/capture of new =canceled= reqres when a corresponding =Track new requests= toggles {{{config2(collecting,(glob))}}}, {{{perSource(collecting)}}} are enabled and {{{config2(collectingWorkOffline,this toggle)}}} is set;
  ...
  though, note that those newly generated =canceled= reqres will be marked as =problematic= if {{{config2(markProblematicWithImportantErrors,that option)}}} is enabled.

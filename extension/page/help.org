...
To forget about them, you will have to unset the /problematic/ flag on the respective reqres via [[./popup.html#unmarkProblematic][this button]], or [[./popup.html#unmarkTabProblematic][this one]], or use similar buttons in the [[./popup.html#showState][log]].
** Step 4: Archival

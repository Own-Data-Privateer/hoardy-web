...
So, for illustrative purposes, I installed the `Hoardy-Web` extension and visited a Wikipedia page:
...
So, then, I decided I do want to save it, so I pressed the lower of "In limbo" check-mark buttons there to collect and archive everything from that tab to my [`hoardy-web serve`](./tool/) archiving server instance.
...
See [there](./doc/gallery.md) for more screenshots, including those with `Hoardy-Web` running on Chromium.

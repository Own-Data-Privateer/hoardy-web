...
- [What is `Hoardy-Web`?](#what-is-hoardy-web)
- [Who `Hoardy-Web` is for?](#who-hoardy-web-is-for)
   * [The litmus test](#the-litmus-test)
- [Walkthrough](#walkthrough)
   * [The magic](#the-magic)
   * [Well, alright, this is kinda nice, but I. Need. More! POWER!](#well-alright-this-is-kinda-nice-but-i-need-more-power)
- [<span id="pieces"/>Parts and pieces](#parts-and-pieces)
   * [The `Hoardy-Web` WebExtensions browser add-on](#the-hoardy-web-webextensions-browser-add-on)
   * [The `hoardy-web` tool](#the-hoardy-web-tool)
   * [The `hoardy-web-sas` simple archiving server](#the-hoardy-web-sas-simple-archiving-server)
   * [A patch for Firefox](#a-patch-for-firefox)
- [What `Hoardy-Web` is most similar to?](#what-hoardy-web-is-most-similar-to)
- [Does the author eat what he cooks?](#does-the-author-eat-what-he-cooks)
- [Quickstart](#quickstart)
   * [Install `Hoardy-Web` browser extension/add-on](#install-hoardy-web-browser-extensionadd-on)
   * [... check it actually works](#-check-it-actually-works)
   * [... and you are done](#-and-you-are-done)
   * [... except, you should probably switch to `Submit dumps via 'HTTP'` mode](#-except-you-should-probably-switch-to-submit-dumps-via-http-mode)
   * [... or if you are unable or unwilling to do that](#-or-if-you-are-unable-or-unwilling-to-do-that)
- [Alternatively, on a system with Nix package manager](#alternatively-on-a-system-with-nix-package-manager)
- [<span id="setup"/>Setup recommendations](#setup-recommendations)
- [Recommended next steps](#recommended-next-steps)
- [<span id="why"/>Why does `Hoardy-Web` exists?](#why-does-hoardy-web-exists)
- [<span id="philosophy"/>Technical Philosophy](#technical-philosophy)
- [<span id="alternatives"/>Alternatives](#alternatives)
   * [DownloadNet](#downloadnet)
   * [mitmproxy](#mitmproxy)
   * [But you could just enable request logging in your browser's Network Monitor and manually save your data as `HAR` archives from time to time](#but-you-could-just-enable-request-logging-in-your-browsers-network-monitor-and-manually-save-your-data-as-har-archives-from-time-to-time)
   * [But you could setup SSL keys dumping then use `Wireshark`, or `tcpdump`, or some such, to capture your web traffic](#but-you-could-setup-ssl-keys-dumping-then-use-wireshark-or-tcpdump-or-some-such-to-capture-your-web-traffic)
   * [archiveweb.page and replayweb.page](#archivewebpage-and-replaywebpage)
   * [SingleFile and WebScrapBook](#singlefile-and-webscrapbook)
   * [WorldBrain Memex](#worldbrain-memex)
   * [pywb](#pywb)
   * [heritrix](#heritrix)
   ...
   * [Archivy](#archivy)
   * [Others](#others)
- [If you like this, you might also like](#if-you-like-this-you-might-also-like)
   * [Perkeep](#perkeep)
- [Meta](#meta)
   * [Changelog?](#changelog)
   * [TODO?](#todo)
...
Then, I pressed the "Replay" button to switch to a replay page generated by `hoardy-web serve` for the above capture (i.e. that button automatically re-navigated that tab to <http://127.0.0.1:3210/web/2/https://en.wikipedia.org/wiki/Bibliometrics>, which `hoardy-web serve` then immediately redirected to the latest archived replay version of that URL):
